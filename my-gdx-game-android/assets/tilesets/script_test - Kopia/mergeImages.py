...
##            bbox = image.getbbox()
            image = image.transform((imageSize[0] + imageSpacing, imageSize[1] + imageSpacing), Image.QUAD, (0,0,0,imageSize[1], imageSize[0], imageSize[1], imageSize[0], 0))
##            print bbox
            print image
...
##            print imageSpacing
            ...
            pos = ((x * imageSize[0]) + imageSpacing, (y * imageSize[1]) + imageSpacing)
            blankImage.paste(images[i][1], pos)
            i += 1
